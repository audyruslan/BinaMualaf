<?php 
    $title = "Tambah Rekam Medis - Puskesmas Bahodopi";
    $menu = "Tambah Rekam Medis";
...
<div class="content"> 
    ...
    <form action="data/tambah_training.php" method="POST">
        ...
        <div class="intro-y grid grid-cols-12 gap-5 mt-5">
            ...
            <div class="col-span-12 lg:col-span-3">
                <label for="id_penyakit" class="form-label">Diagnosa Penyakit</label>
            ...
            <div class="col-span-12">
                ...
                <!-- <div class="grid grid-cols-12 gap-5 pt-5">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="gejala" name="gejala[]" value="0">
                        <input id="<?= $row["id"]; ?>" class="form-check-input" type="checkbox" name="gejala[]"
                            value="<?= $row["id"]; ?>">
                ...
                <div class="grid grid-cols-12 gap-5 pt-5">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="nyeri_menelan" class="form-check-input" type="checkbox" name="nyeri_menelan" value="5">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="nyeri_lambung" class="form-check-input" type="checkbox" name="nyeri_lambung" value="6">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="perut_kembung" class="form-check-input" type="checkbox" name="perut_kembung" value="7">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="gangguan_saluran_pencernaan" name="gangguan_saluran_pencernaan" value="0">
                        <input id="gangguan_saluran_pencernaan" class="form-check-input" type="checkbox" name="gangguan_saluran_pencernaan" value="10">
                        <label class="form-check-label" for="gangguan_saluran_pencernaan">Gangguan Saluran Pencernaan</label>
                    </div>
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="tidak_nafsu_makan" class="form-check-input" type="checkbox" name="tidak_nafsu_makan" value="12">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="darah_pada_feses" class="form-check-input" type="checkbox" name="darah_pada_feses" value="13">
                        <label class="form-check-label" for="darah_pada_feses">Darah Pada Feses</label>
                    </div>

                    <!-- Kulit Ruam Kemerahan Gatal -->
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="kulit_ruam_kemerahan_gatal" name="kulit_ruam_kemerahan_gatal" value="0">
                        <input id="kulit_ruam_kemerahan_gatal" class="form-check-input" type="checkbox" name="kulit_ruam_kemerahan_gatal" value="14">
                        <label class="form-check-label" for="kulit_ruam_kemerahan_gatal">Kulit Ruam Kemerahan Gatal</label>
                    </div>

                    <!-- Lepuh Berisi Air -->
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="lepuh_berisi_air" name="lepuh_berisi_air" value="0">
                        <input id="lepuh_berisi_air" class="form-check-input" type="checkbox" name="lepuh_berisi_air" value="15">
                        <label class="form-check-label" for="lepuh_berisi_air">Lepuh berisi Air</label>
                    </div>

                    <!-- Kulit Membengkak -->
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="kulit_membengkak" name="kulit_membengkak" value="0">
                        <input id="kulit_membengkak" class="form-check-input" type="checkbox" name="kulit_membengkak" value="16">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="sakit_dada" class="form-check-input" type="checkbox" name="sakit_dada" value="17">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="gelisa" class="form-check-input" type="checkbox" name="gelisa" value="18">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="mudah_lelah" class="form-check-input" type="checkbox" name="mudah_lelah" value="19">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="jantung_berdebar" class="form-check-input" type="checkbox" name="jantung_berdebar" value="20">
                    ...
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        ...
                        <input id="kulit_gatal" class="form-check-input" type="checkbox" name="kulit_gatal" value="21">
                        <label class="form-check-label" for="kulit_gatal">Kulit Gatal</label>
                    </div>

                    <!-- Kulit Kering Bersisik Pecah -->
                    <div class="form-check mt-2 intro-y block col-span-12 sm:col-span-3 2xl:col-span-3">
                        <input type="hidden" id="kulit_kering_bersisik_pecah" name="kulit_kering_bersisik_pecah" value="0">
                        <input id="kulit_kering_bersisik_pecah" class="form-check-input" type="checkbox" name="kulit_kering_bersisik_pecah" value="22">
                        <label class="form-check-label" for="kulit_kering_bersisik_pecah">Kulit Kering Bersisik Pecah</label>
                    </div>
